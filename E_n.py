...
# Creating our basis: returns every x such that Q_x Q_i ( x^d ) is still a basis element
def op_range( gen_deg, op_deg ):
    return range( 1, min( [ n - 1, max_dim - gen_deg, op_deg ] ) + 1 )
